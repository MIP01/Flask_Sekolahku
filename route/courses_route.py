...
from controller.user_course_controller import create_user_course_handler, get_all_user_course_handler, get_course_participants_handler, update_user_course_handler, delete_user_course_handler
...
user_course_bp.route('/pilihan', methods=['GET'])(get_course_participants_handler)
